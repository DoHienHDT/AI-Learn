...
class Memo {
    ...
    init(category_id: Int,category_name:String,collection_time: String,content: String,kml_id: Int,lat: String,lng: String,memo_at: Double,memo_at_str: String,user_id: Int,user_name:String, link_video: String){
